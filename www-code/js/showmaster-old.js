...
const updateMicList = (scene_index, page) => {
    const pageList = () => {
        ...
        for (let page = firstpage; page < lastpage; page++) {
            ...
            for (line of page_lines) {
                ...
                for (ensemble of line.ensembles) {
                    ...
                    for (role of roles) {
console.log('ROLE:', ensemble, role, current_roles[role])
                        passive_mics.add(current_roles[role])
                    }
                    for (actor of extras) {
console.log('ACTOR:', ensemble, actor, current_actors[actor])
                        passive_mics.add(current_actors[actor])
                    }
                }
            }
        }
...
const updateLocation = (type, pagesource) => {
    ...
    renderPdf(current_page.target)
    updateMicList(scene_index, current_page.target)
}
